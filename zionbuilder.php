...
function zionbuilder_fail_php_version() {
	...
	$message = sprintf( esc_html__( 'RavenciBuilder requires at least PHP version %s. Please contact your hosting provider and ask them to update the PHP version used on your server. RavenciBuilder will not be activated until the minimum PHP version is installed.', 'zionbuilder' ), '5.4' );
...
function zionbuilder_fail_wp_version() {
	...
	$message = sprintf( esc_html__( 'RavenciBuilder requires at least WordPress version %s. Please update WordPress to the latest version. RavenciBuilder will not be activated until the minimum WordPress version is installed.', 'zionbuilder' ), '4.9' );
